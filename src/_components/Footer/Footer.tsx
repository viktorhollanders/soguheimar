...
export default function Footer() {
  ...
  const mapLink = 'https://maps.app.goo.gl/JZMEqS1XSbB5hKvN7';
  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.infoContainer}>
        ...
        <Link id={styles.mapLink} className={styles.link} href={mapLink}>
          Sjá kort
        </Link>
      </div>
      <div className={styles.infoContainer}>
        ...
        <div className={styles.contactItem}>
          ...
          <a className={styles.link} href="mailto:söguheimar@gmail.com">
